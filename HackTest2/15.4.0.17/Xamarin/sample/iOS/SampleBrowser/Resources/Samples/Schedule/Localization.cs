			...
			foreach (var view in this.Subviews) {
				if (view is SFSchedule) {
					...
					if (deviceType == "iPhone" || deviceType == "iPod touch")
					{
						...
						button.Frame = new CGRect(this.Frame.X + 10, ((this.Frame.Size.Height / 2)) + 30, this.Frame.Size.Width - 20, 30);
						scheduleTypePicker.Frame = new CGRect(0, (this.Frame.Size.Height / 2) + 20, this.Frame.Size.Width, 200);
					}
					else
					{
