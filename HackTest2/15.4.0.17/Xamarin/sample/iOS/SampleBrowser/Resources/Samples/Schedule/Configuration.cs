...
namespace SampleBrowser
{
	public class Configuration :SampleView
	{
		...
		private void CreateOptionView()
		{
			...
			_rangeslider.Delegate = new RangeSliderMobileDelegate();
		...
		public class RangeSliderMobileDelegate : SFRangeSliderDelegate
		{
			...
			{
				schedule.DayViewSettings.WorkStartHour = (int)start;
				schedule.DayViewSettings.WorkEndHour = (int)end;
				schedule.WeekViewSettings.WorkStartHour = (int)start;
				schedule.WeekViewSettings.WorkEndHour = (int)end;
				schedule.WorkWeekViewSettings.WorkStartHour = (int)start;
				schedule.WorkWeekViewSettings.WorkEndHour = (int)end;
			}
		}
	}
}
