...
namespace SampleBrowser
{
    public partial class DigitalSignature : SampleView
    {
        ...
        void LoadAllowedTextsLabel()
        {
            ...
            label.Text = "Essential PDF's support for sign an existing PDF document.";
            ...
            label1.Text = "This sample demonstrates the support for Digital Sigature in Essential PDF.";
