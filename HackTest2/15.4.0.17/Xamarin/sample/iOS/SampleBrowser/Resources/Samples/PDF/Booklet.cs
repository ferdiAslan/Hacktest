...
namespace SampleBrowser
{
    public partial class Booklet : SampleView
    {
        ...
        void LoadAllowedTextsLabel()
        {
            ...
            label.Text = "Essential PDF's support for creating a booklet from an existing PDF document.";
            ...
            label1.Text = "This sample demonstrates the creation of booklet from an existing PDF document.";
        ...
        {
            Stream docStream = typeof(Booklet).GetTypeInfo().Assembly.GetManifestResourceStream("SampleBrowser.Samples.PDF.Assets.Syncfusion_Windows8_whitepaper.pdf");
