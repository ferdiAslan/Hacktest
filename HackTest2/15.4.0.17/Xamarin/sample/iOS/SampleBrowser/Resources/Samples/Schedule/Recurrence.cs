...
//			ClientMeeting_Recurrence.AppointmentBackground = UIColor.FromRGB(red:0.106, green:0.631, blue:0.886 );
	...
	public class scheduleDelegate : SFScheduleDelegate
	{
        ...
        {
            monthCellLoaded.MonthInlineViewStyle.BackgroundColor = UIColor.FromRGB(246, 246, 246);
			monthCellLoaded.MonthInlineViewStyle.TextColor = UIColor.Black;
        }
        public override void didMonthInlineAppointmentLoaded(SFMonthInlineAppointmentLoaded monthCellLoaded)
        {
            ...
            startTime.Text = DateTime.Parse(monthCellLoaded.Appointment.StartTime.ToString()).ToString("hh:mm tt");
            ...
            endTime.Text = DateTime.Parse((monthCellLoaded.Appointment.EndTime.ToString())).ToString("hh:mm tt");
            ...
            subject.Text = monthCellLoaded.Appointment.Subject.ToString();
