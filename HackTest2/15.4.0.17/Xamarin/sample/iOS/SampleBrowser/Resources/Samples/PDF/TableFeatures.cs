...
namespace SampleBrowser
{
    public partial class TableFeatures : SampleView
    {
        ...
        void LoadAllowedTextsLabel()
        {
            ...
            label.Text = "The PdfLightTable class represents simple tables that are used for publishing structured data from an IEnumerable source. There are no real cells or rows in those tables, and all data is taken from the data source using the DataSource property.";
            ...
            label1.Text = "This sample demonstrates the creation of tables in PDF document.";
