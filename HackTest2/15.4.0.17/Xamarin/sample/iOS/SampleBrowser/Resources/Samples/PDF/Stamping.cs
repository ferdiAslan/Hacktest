...
namespace SampleBrowser
{
    public partial class Stamping : SampleView
    {
        ...
        void LoadAllowedTextsLabel()
        {
            ...
            label.Text = "Stamping is often used in documents to ensure that the content has not been modified. Essential PDF provides support for stamping PDF documents with either images or text.";
            ...
            label1.Text = "This sample demonstrates the creation of stamping an existing PDF document.";
        ...
        {
            Stream docStream = typeof(Stamping).GetTypeInfo().Assembly.GetManifestResourceStream("SampleBrowser.Samples.PDF.Assets.Syncfusion_Windows8_whitepaper.pdf");
