...
namespace SampleBrowser
{
	public class Configuration : SamplePage
	{
		...
		public override View GetSampleContent(Context context)
		{
			...
			sfschedule.MonthViewSettings.BlackoutDates = black_dates;
			...
			sfschedule.WeekViewSettings.NonAccessibleBlocks = nonAccessibleBlocks;
			sfschedule.WorkWeekViewSettings.NonAccessibleBlocks = nonAccessibleBlocks;
			sfschedule.MonthViewSettings = SetBlackoutDates();
		...
		private MonthViewSettings SetBlackoutDates()
		{
			ObservableCollection<Calendar> black_dates = new ObservableCollection<Calendar>();
			Calendar currentDate = Calendar.Instance;
			Calendar firstDate = (Calendar)currentDate.Clone();
			...
			black_dates.Add(thirdDate);
			monthsettings.BlackoutDates = black_dates;
		...
		private void show_Non_Accessible_Block_checkBox_CheckedChange(object sender, CompoundButton.CheckedChangeEventArgs e)
		{
			if (e.IsChecked)
			{
				...
				nonAccessibleBlocksCollection.Add(lunch);
				nonAccessibleBlocks = nonAccessibleBlocksCollection;
				sfschedule.DayViewSettings.NonAccessibleBlocks = nonAccessibleBlocksCollection;
				sfschedule.WeekViewSettings.NonAccessibleBlocks = nonAccessibleBlocksCollection;
				sfschedule.WorkWeekViewSettings.NonAccessibleBlocks = nonAccessibleBlocksCollection;

			}
			else
			{
				sfschedule.DayViewSettings.NonAccessibleBlocks = new NonAccessibleBlocksCollection();
				sfschedule.WeekViewSettings.NonAccessibleBlocks = new NonAccessibleBlocksCollection();
				sfschedule.WorkWeekViewSettings.NonAccessibleBlocks = new NonAccessibleBlocksCollection();
			}
		...
		private void show_Blackout_Dates_CheckedChange(object sender, CompoundButton.CheckedChangeEventArgs e)
		{
			...
			{
				sfschedule.MonthViewSettings = new MonthViewSettings();
			}
			isInitialLoad = false;
		}
		//void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
