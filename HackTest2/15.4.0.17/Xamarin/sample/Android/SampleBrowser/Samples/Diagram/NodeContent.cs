...
namespace SampleBrowser
{
    public partial class NodeAnnotation : SamplePage
    {
        ...
        public override View GetSampleContent(Context context)
        {
            ...
            var node1 = DrawNode(280 * 2, 140 * 2, 175 * 2, 70 * 2, ShapeType.RoundedRectangle);
            ...
            var node2 = DrawNode(280 * 2, node1.OffsetY + (90 * 2), 175 * 2, 70 * 2, ShapeType.RoundedRectangle);
            ...
            var node3 = DrawNode(280 * 2, node2.OffsetY + (90 * 2), 175 * 2, 70 * 2, ShapeType.RoundedRectangle);
            ...
            var node4 = DrawNode(280 * 2, node3.OffsetY + (90 * 2), 175 * 2, 70 * 2, ShapeType.RoundedRectangle);
            ...
            var node5 = DrawNode(280 * 2, node4.OffsetY + (90 * 2), 175 * 2, 70 * 2, ShapeType.RoundedRectangle);
            ...
            diagram.AddConnector(DrawConnector(node1, node2, node1.Ports[2], node2.Ports[0], SegmentType.OrthoSegment, Color.Rgb(127, 132, 133), StrokeStyle.Default, DecoratorType.Filled45Arrow, Color.Rgb(255, 255, 255), Color.Rgb(127, 132, 133), 8));

            diagram.AddConnector(DrawConnector(node2, node3, node2.Ports[2], node3.Ports[0], SegmentType.OrthoSegment, Color.Rgb(127, 132, 133), StrokeStyle.Default, DecoratorType.Filled45Arrow, Color.Rgb(255, 255, 255), Color.Rgb(127, 132, 133), 8));

            diagram.AddConnector(DrawConnector(node3, node4, node3.Ports[2], node4.Ports[0], SegmentType.OrthoSegment, Color.Rgb(127, 132, 133), StrokeStyle.Default, DecoratorType.Filled45Arrow, Color.Rgb(255, 255, 255), Color.Rgb(127, 132, 133), 8));

            diagram.AddConnector(DrawConnector(node4, node5, node4.Ports[2], node5.Ports[0], SegmentType.OrthoSegment, Color.Rgb(127, 132, 133), StrokeStyle.Default, DecoratorType.Filled45Arrow, Color.Rgb(255, 255, 255), Color.Rgb(127, 132, 133), 8));

            diagram.AddConnector(DrawConnector(node6, node1, node6.Ports[0], node1.Ports[3], SegmentType.OrthoSegment, Color.Rgb(127, 132, 133), StrokeStyle.Dashed, DecoratorType.Filled45Arrow, Color.Rgb(255, 255, 255), Color.Rgb(127, 132, 133), 8));

            diagram.AddConnector(DrawConnector(node8, node1, node8.Ports[0], node1.Ports[1], SegmentType.OrthoSegment, Color.Rgb(127, 132, 133), StrokeStyle.Dashed, DecoratorType.Filled45Arrow, Color.Rgb(255, 255, 255), Color.Rgb(127, 132, 133), 8));
        ...
        Node DrawNode(float x, float y, float w, float h, ShapeType shape)
        {
            ...
            node.Width = w * MainActivity.factor;
            node.Height = h * MainActivity.factor;
